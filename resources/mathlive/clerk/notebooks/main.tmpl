...
;; template](https://mathlive.mentat.org/#project-template). The template comes with
...
(clerk/eval-cljs
 ...
 '(require '[mathlive.core :as mathlive]))
...
;; One potential wrinkle to note when using `MathLive.cljs` in Clerk is that you
;; have to define any function you'd like to use over on the ClojureScript side.
;; You won't be able to use this function (defined on the JVM) with MathLive:
