...
> **Note**
> This project was generated by the [`mathlive/clerk`
> template](https://github.com/mentat-collective/MathLive.cljs/tree/main/resources/mathlive/clerk)
> from [`MathLive.cljs`](https://mathlive.mentat.org).

This project allows you to interactively develop [Clerk][clerk-url] notebooks
using [`MathLive.cljs`](https://mathlive.mentat.org) code inside of your
