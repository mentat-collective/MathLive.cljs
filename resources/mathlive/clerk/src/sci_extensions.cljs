...
;; ## MathLive.cljs installation
;;
;; This first section installs all `MathLive.cljs` namespaces into the project:

(mathlive.sci/install!)

;; See [`MathLive.cljs` via SCI](https://mathlive.mentat.org/#mathlive.cljs-via-sci) for
;; more details.
