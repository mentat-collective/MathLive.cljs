(ns build
  "tools.build declarations for the mathlive.cljs library."
  ...
  (let [version  (->version version-suffix)
    ...
    (b/write-pom
     {:class-dir class-dir
      ...
      :scm
      {:tag (str "v" version)
       :connection "scm:git:git://github.com/mentat-collective/mathlive.cljs.git"
       :developConnection "scm:git:ssh://git@github.com/mentat-collective/mathlive.cljs.git"
       :url "https://github.com/mentat-collective/mathlive.cljs"}
      :basis basis
