...
var G__54552 = devtools.prefs.pref(v);
v = G__54552;
continue;
} else {
return v;
...
}catch (e54487){var _e__53803__auto__ = e54487;
return false;
}})();
...
}catch (e54498){var _e__53803__auto__ = e54498;
return false;
}})();
...
}catch (e54500){var _e__53803__auto__ = e54500;
return false;
}}
}
});
...
var vec__54510 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54510,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54510,(1),null);
...
return cljs.core.some((function (p1__54521_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__54521_SHARP_);
}),template);
});
