...
var G__64955 = o;
reagent.impl.template.goog$module$goog$object.set(G__64955,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__65065__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__65065 = function (var_args){
var args = null;
...
while (G__65066__i < G__65066__a.length) {G__65066__a[G__65066__i] = arguments[G__65066__i + 0]; ++G__65066__i;}
  args = new cljs.core.IndexedSeq(G__65066__a,0,null);
} 
return G__65065__delegate.call(this,args);};
G__65065.cljs$lang$maxFixedArity = 0;
G__65065.cljs$lang$applyTo = (function (arglist__65067){
var args = cljs.core.seq(arglist__65067);
return G__65065__delegate(args);
});
G__65065.cljs$core$IFn$_invoke$arity$variadic = G__65065__delegate;
return G__65065;
})()
;
} else {
...
var G__64968 = o;
reagent.impl.template.goog$module$goog$object.set(G__64968,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__65069__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__65070__i < G__65070__a.length) {G__65070__a[G__65070__i] = arguments[G__65070__i + 0]; ++G__65070__i;}
  args = new cljs.core.IndexedSeq(G__65070__a,0,null);
} 
return G__65069__delegate.call(this,args);};
G__65069.cljs$lang$maxFixedArity = 0;
G__65069.cljs$lang$applyTo = (function (arglist__65071){
var args = cljs.core.seq(arglist__65071);
return G__65069__delegate(args);
});
...
var G__64975 = props;
var G__64975__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__64975,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__64975);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__64975__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__64976 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__64976,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__64976;
}
})(),id_class);
...
var G__64979 = (cljs.core.count(argv) - first_child);
switch (G__64979) {
case (0):
...
var vec__64984 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64984,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64984,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64984,(2),null);
...
var temp__5757__auto___65082 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___65082 == null)){
} else {
var key_65083 = temp__5757__auto___65082;
(jsprops.key = key_65083);
}
...
var temp__5757__auto___65085 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___65085 == null)){
} else {
var key_65086 = temp__5757__auto___65085;
(jsprops.key = key_65086);
}
...
var temp__5757__auto___65087 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___65087 == null)){
} else {
var key_65088 = temp__5757__auto___65087;
(jsprops.key = key_65088);
}
...
var temp__5757__auto___65093 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___65093 == null)){
} else {
var key_65094 = temp__5757__auto___65093;
(jsprops.key = key_65094);
}
...
var temp__5757__auto___65095 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___65095 == null)){
} else {
var key_65096 = temp__5757__auto___65095;
(jsprops.key = key_65096);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__65046_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__65046_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__65049 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65049,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65049,(1),null);
...
var G__65056 = tag;
var G__65056__$1 = (((G__65056 instanceof cljs.core.Keyword))?G__65056.fqn:null);
switch (G__65056__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template65059 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template65059 = (function (opts,id,fn_to_element,parse_fn,meta65060){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template65059.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_65061,meta65060__$1){
var self__ = this;
var _65061__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template65059(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta65060__$1));
}));

(reagent.impl.template.t_reagent$impl$template65059.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_65061){
var self__ = this;
var _65061__$1 = this;
return self__.meta65060;
}));

(reagent.impl.template.t_reagent$impl$template65059.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template65059.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template65059.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template65059.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template65059.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template65059.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta65060","meta65060",126242541,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template65059.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template65059.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template65059");

(reagent.impl.template.t_reagent$impl$template65059.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template65059");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template65059.
 */
reagent.impl.template.__GT_t_reagent$impl$template65059 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template65059(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta65060){
return (new reagent.impl.template.t_reagent$impl$template65059(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta65060));
});

}

return (new reagent.impl.template.t_reagent$impl$template65059(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
