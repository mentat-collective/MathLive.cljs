...
var len__4864__auto___57181 = arguments.length;
var i__4865__auto___57182 = (0);
while(true){
if((i__4865__auto___57182 < len__4864__auto___57181)){
args__4870__auto__.push((arguments[i__4865__auto___57182]));

var G__57183 = (i__4865__auto___57182 + (1));
i__4865__auto___57182 = G__57183;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.throw_ex.cljs$lang$applyTo = (function (seq57099){
var G__57100 = cljs.core.first(seq57099);
var seq57099__$1 = cljs.core.next(seq57099);
var G__57101 = cljs.core.first(seq57099__$1);
var seq57099__$2 = cljs.core.next(seq57099__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57100,G__57101,seq57099__$2);
}));
...
var args__4870__auto__ = [];
var len__4864__auto___57184 = arguments.length;
var i__4865__auto___57185 = (0);
while(true){
if((i__4865__auto___57185 < len__4864__auto___57184)){
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.reader_error.cljs$lang$applyTo = (function (seq57112){
var G__57113 = cljs.core.first(seq57112);
var seq57112__$1 = cljs.core.next(seq57112);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57113,seq57112__$1);
}));
...
var args__4870__auto__ = [];
var len__4864__auto___57187 = arguments.length;
var i__4865__auto___57188 = (0);
while(true){
if((i__4865__auto___57188 < len__4864__auto___57187)){
args__4870__auto__.push((arguments[i__4865__auto___57188]));

var G__57189 = (i__4865__auto___57188 + (1));
i__4865__auto___57188 = G__57189;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.illegal_arg_error.cljs$lang$applyTo = (function (seq57114){
var G__57115 = cljs.core.first(seq57114);
var seq57114__$1 = cljs.core.next(seq57114);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57115,seq57114__$1);
}));
...
var args__4870__auto__ = [];
var len__4864__auto___57190 = arguments.length;
var i__4865__auto___57191 = (0);
while(true){
if((i__4865__auto___57191 < len__4864__auto___57190)){
args__4870__auto__.push((arguments[i__4865__auto___57191]));

var G__57192 = (i__4865__auto___57191 + (1));
i__4865__auto___57191 = G__57192;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.eof_error.cljs$lang$applyTo = (function (seq57116){
var G__57117 = cljs.core.first(seq57116);
var seq57116__$1 = cljs.core.next(seq57116);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57117,seq57116__$1);
}));
...
var args__4870__auto__ = [];
var len__4864__auto___57194 = arguments.length;
var i__4865__auto___57195 = (0);
while(true){
if((i__4865__auto___57195 < len__4864__auto___57194)){
args__4870__auto__.push((arguments[i__4865__auto___57195]));

var G__57196 = (i__4865__auto___57195 + (1));
i__4865__auto___57195 = G__57196;
continue;
} else {
}
break;
...
var init = (function (){var G__57158 = kind;
var G__57158__$1 = (((G__57158 instanceof cljs.core.Keyword))?G__57158.fqn:null);
switch (G__57158__$1) {
case "regex":
return "#\"";
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57158__$1)].join('')));
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.throw_eof_reading.cljs$lang$applyTo = (function (seq57138){
var G__57139 = cljs.core.first(seq57138);
var seq57138__$1 = cljs.core.next(seq57138);
var G__57140 = cljs.core.first(seq57138__$1);
var seq57138__$2 = cljs.core.next(seq57138__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57139,G__57140,seq57138__$2);
}));
...
var iter__4652__auto__ = (function cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__57171(s__57172){
return (new cljs.core.LazySeq(null,(function (){
var s__57172__$1 = s__57172;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__57172__$1);
if(temp__5753__auto__){
var s__57172__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__57172__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__57172__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__57174 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__57173 = (0);
while(true){
if((i__57173 < size__4651__auto__)){
var vec__57175 = cljs.core._nth(c__4650__auto__,i__57173);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57175,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57175,(1),null);
if((freq > (1))){
cljs.core.chunk_append(b__57174,id);

var G__57201 = (i__57173 + (1));
i__57173 = G__57201;
continue;
} else {
var G__57202 = (i__57173 + (1));
i__57173 = G__57202;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__57174),cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__57171(cljs.core.chunk_rest(s__57172__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__57174),null);
}
} else {
var vec__57178 = cljs.core.first(s__57172__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57178,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57178,(1),null);
if((freq > (1))){
return cljs.core.cons(id,cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__57171(cljs.core.rest(s__57172__$2)));
} else {
var G__57203 = cljs.core.rest(s__57172__$2);
s__57172__$1 = G__57203;
continue;
}
}
} else {
