...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__64911){
var map__64912 = p__64911;
var map__64912__$1 = cljs.core.__destructure_map(map__64912);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64912__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
(jsprops.onChange = (function (p1__64915_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__64915_SHARP_);
}));
