...
var s__$1 = clojure.string.escape(s,new cljs.core.PersistentArrayMap(null, 1, ["\"","\\\""], null));
var lines = cljs.core.PersistentVector.EMPTY;
while(true){
var temp__5751__auto__ = cljs.core.first(cljs.core.re_find(/(\r\n|\r|\n)/,s__$1));
if(cljs.core.truth_(temp__5751__auto__)){
var m = temp__5751__auto__;
var eol_ndx = clojure.string.index_of.cljs$core$IFn$_invoke$arity$2(s__$1,m);
var G__66744 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s__$1,(eol_ndx + cljs.core.count(m)));
var G__66745 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(lines,cljs.core.subs.cljs$core$IFn$_invoke$arity$3(s__$1,(0),eol_ndx));
s__$1 = G__66744;
lines = G__66745;
continue;
} else {
...
var comma_66748 = rewrite_clj.node.whitespace.whitespace_nodes(", ");
var space_66749 = rewrite_clj.node.whitespace.whitespace_node(" ");
rewrite_clj.node.coercer.map__GT_children = (function rewrite_clj$node$coercer$map__GT_children(m){
return cljs.core.vec(cljs.core.drop_last.cljs$core$IFn$_invoke$arity$2(cljs.core.count(comma_66748),cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__66734){
var vec__66735 = p__66734;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66735,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66735,(1),null);
return cljs.core.list_STAR_.cljs$core$IFn$_invoke$arity$4(rewrite_clj.node.protocols.coerce(k),space_66749,rewrite_clj.node.protocols.coerce(v),comma_66748);
...
return rewrite_clj.node.coercer.node_with_meta((function (){var G__66738 = cljs.core.vec(rewrite_clj.node.whitespace.space_separated(cljs.core.map.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.coerce,sq)));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__66738) : f.call(null,G__66738));
})(),sq);
});
