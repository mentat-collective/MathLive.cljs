...
var sym_seq = (function (){var iter__4652__auto__ = (function rewrite_clj$node$fn$fn_walk_$_iter__66222(s__66223){
return (new cljs.core.LazySeq(null,(function (){
var s__66223__$1 = s__66223;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__66223__$1);
if(temp__5753__auto__){
var s__66223__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__66223__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__66223__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__66225 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__66224 = (0);
while(true){
if((i__66224 < size__4651__auto__)){
var i = cljs.core._nth(c__4650__auto__,i__66224);
...
cljs.core.chunk_append(b__66225,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')));

var G__66346 = (i__66224 + (1));
i__66224 = G__66346;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__66225),rewrite_clj$node$fn$fn_walk_$_iter__66222(cljs.core.chunk_rest(s__66223__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__66225),null);
}
} else {
var i = cljs.core.first(s__66223__$2);
var base = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(0)))?"rest__":["p",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),"__"].join(''));
var s = cljs.core.name(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1(base));
return cljs.core.cons(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')),rewrite_clj$node$fn$fn_walk_$_iter__66222(cljs.core.rest(s__66223__$2)));
}
} else {
return null;
}
...
var body = clojure.walk.prewalk((function (p1__66220_SHARP_){
var or__4253__auto__ = rewrite_clj.node.fn.arg_symbol__GT_gensym(sym_seq,vararg_QMARK_,max_fixed_arg_ndx,p1__66220_SHARP_);
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return p1__66220_SHARP_;
}
}),form);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k66244,else__4505__auto__){
var self__ = this;
var this__4504__auto____$1 = this;
var G__66258 = k66244;
var G__66258__$1 = (((G__66258 instanceof cljs.core.Keyword))?G__66258.fqn:null);
switch (G__66258__$1) {
case "children":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k66244,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__66265){
var vec__66266 = p__66265;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66266,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66266,(1),null);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__66243){
var self__ = this;
var G__66243__$1 = this;
return (new cljs.core.RecordIter((0),G__66243__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this66245,other66246){
var self__ = this;
var this66245__$1 = this;
return (((!((other66246 == null)))) && ((((this66245__$1.constructor === other66246.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this66245__$1.children,other66246.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this66245__$1.__extmap,other66246.__extmap)))))));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k66244){
var self__ = this;
var this__4509__auto____$1 = this;
var G__66321 = k66244;
var G__66321__$1 = (((G__66321 instanceof cljs.core.Keyword))?G__66321.fqn:null);
switch (G__66321__$1) {
case "children":
return true;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k66244);

}
}));

(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__66243){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__66323 = cljs.core.keyword_identical_QMARK_;
var expr__66324 = k__4511__auto__;
if(cljs.core.truth_((pred__66323.cljs$core$IFn$_invoke$arity$2 ? pred__66323.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__66324) : pred__66323.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__66324)))){
return (new rewrite_clj.node.fn.FnNode(G__66243,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.fn.FnNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__66243),null));
}
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__66243){
var self__ = this;
var this__4501__auto____$1 = this;
return (new rewrite_clj.node.fn.FnNode(self__.children,G__66243,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.fn.map__GT_FnNode = (function rewrite_clj$node$fn$map__GT_FnNode(G__66248){
var extmap__4542__auto__ = (function (){var G__66341 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__66248,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__66248)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__66341);
} else {
return G__66341;
}
})();
return (new rewrite_clj.node.fn.FnNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__66248),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
