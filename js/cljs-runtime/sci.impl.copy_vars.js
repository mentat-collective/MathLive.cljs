...
break;
case 5:
return sci.impl.copy_vars.macrofy_STAR_.cljs$core$IFn$_invoke$arity$5((arguments[(0)]),(arguments[(1)]),(arguments[(2)]),(arguments[(3)]),(arguments[(4)]));
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f,(function (p1__73502_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__73502_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),true);
}));
}));
...
return sci.impl.copy_vars.macrofy_STAR_.cljs$core$IFn$_invoke$arity$4(sym,f,ns,false);
}));

(sci.impl.copy_vars.macrofy_STAR_.cljs$core$IFn$_invoke$arity$4 = (function (sym,f,ns,ctx_QMARK_){
return sci.impl.copy_vars.macrofy_STAR_.cljs$core$IFn$_invoke$arity$5(sym,f,ns,ctx_QMARK_,null);
}));

(sci.impl.copy_vars.macrofy_STAR_.cljs$core$IFn$_invoke$arity$5 = (function (sym,f,ns,ctx_QMARK_,extra_meta){
var ns__$1 = (function (){var or__4253__auto__ = ns;
...
return sci.impl.utils.new_var.cljs$core$IFn$_invoke$arity$4(sym,f,(function (){var G__73506 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"ns","ns",441598760),ns__$1,new cljs.core.Keyword(null,"macro","macro",-867863404),true,new cljs.core.Keyword("sci","built-in","sci/built-in",1244659599),true], null);
if(cljs.core.truth_((function (){var and__4251__auto__ = (!(sci.impl.copy_vars.elide_vars));
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([G__73506,extra_meta], 0));
} else {
return G__73506;
}
})(),ctx_QMARK_);
...
break;
case 5:
return sci.impl.copy_vars.new_var.cljs$core$IFn$_invoke$arity$5((arguments[(0)]),(arguments[(1)]),(arguments[(2)]),(arguments[(3)]),(arguments[(4)]));
...
return sci.impl.copy_vars.new_var.cljs$core$IFn$_invoke$arity$4(sym,f,null,false);
}));

(sci.impl.copy_vars.new_var.cljs$core$IFn$_invoke$arity$3 = (function (sym,f,ns){
return sci.impl.copy_vars.new_var.cljs$core$IFn$_invoke$arity$4(sym,f,ns,false);
}));

(sci.impl.copy_vars.new_var.cljs$core$IFn$_invoke$arity$4 = (function (sym,f,ns,ctx_QMARK_){
return sci.impl.copy_vars.new_var.cljs$core$IFn$_invoke$arity$5(sym,f,ns,ctx_QMARK_,null);
}));

(sci.impl.copy_vars.new_var.cljs$core$IFn$_invoke$arity$5 = (function (sym,f,ns,ctx_QMARK_,extra_meta){
var ctx_QMARK___$1 = (function (){var or__4253__auto__ = ctx_QMARK_;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return ns === true;
...
var ns__$1 = ((ns === true)?sci.impl.utils.clojure_core_ns:(function (){var or__4253__auto__ = ns;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return sci.impl.utils.clojure_core_ns;
...
return sci.impl.utils.new_var.cljs$core$IFn$_invoke$arity$4(sym,f,(function (){var G__73528 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ns","ns",441598760),ns__$1,new cljs.core.Keyword("sci","built-in","sci/built-in",1244659599),true], null);
if(cljs.core.truth_((function (){var and__4251__auto__ = (!(sci.impl.copy_vars.elide_vars));
if(and__4251__auto__){
return extra_meta;
} else {
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([G__73528,extra_meta], 0));
} else {
return G__73528;
}
})(),ctx_QMARK___$1);
...
(sci.impl.copy_vars.new_var.cljs$lang$maxFixedArity = 5);
