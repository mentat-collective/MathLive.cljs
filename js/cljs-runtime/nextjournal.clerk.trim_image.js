...
var G__75045 = (cljs.core.truth_(from_top_QMARK_)?(y + (1)):(y - (1)));
var G__75046 = (function (){var x = (0);
while(true){
...
var G__75049 = (cljs.core.truth_(from_left_QMARK_)?(x + (1)):(x - (1)));
var G__75050 = (function (){var y = (0);
while(true){
if((!(nextjournal.clerk.trim_image.white_QMARK_(x,y,img_width,img_data)))){
return x;
} else {
...
(nextjournal.clerk.trim_image.trim_image.cljs$core$IFn$_invoke$arity$2 = (function (img,p__75042){
var map__75043 = p__75042;
var map__75043__$1 = cljs.core.__destructure_map(map__75043);
var padding = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__75043__$1,new cljs.core.Keyword(null,"padding","padding",1660304693),(0));
