...
var vec__68051 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__68054,match){
var vec__68055 = p__68054;
var doc__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68055,(0),null);
var ranges = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68055,(1),null);
...
var doc__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68051,(0),null);
var ranges = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68051,(1),null);
return module$node_modules$$codemirror$state$dist$index_cjs.EditorState.create(({"doc": doc__$1, "selection": ((cljs.core.seq(ranges))?module$node_modules$$codemirror$state$dist$index_cjs.EditorSelection.create(cljs.core.to_array(ranges)):undefined), "extensions": (function (){var G__68064 = [module$node_modules$$codemirror$state$dist$index_cjs.EditorState.allowMultipleSelections.of(true)];
if(cljs.core.truth_(extensions)){
var Array68065 = G__68064;
Array68065.push(extensions);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (doc__$1,p__68066){
...
var empty = (function (){var obj68070 = map__68067__$1;
if((!((obj68070 == null)))){
return (obj68070["empty"]);
} else {
return undefined;
}
})();
var from = (function (){var obj68072 = map__68067__$1;
if((!((obj68072 == null)))){
return (obj68072["from"]);
} else {
return undefined;
}
})();
var to = (function (){var obj68074 = map__68067__$1;
if((!((obj68074 == null)))){
return (obj68074["to"]);
} else {
return undefined;
...
var _ = (function (){var G__68086 = ({"state": state, "dispatch": (function (p1__68085_SHARP_){
return cljs.core.reset_BANG_(_BANG_tr,p1__68085_SHARP_);
})});
return (cmd.cljs$core$IFn$_invoke$arity$1 ? cmd.cljs$core$IFn$_invoke$arity$1(G__68086) : cmd.call(null,G__68086));
})();
var tr = cljs.core.deref(_BANG_tr);
return nextjournal.clojure_mode.test_utils.state_str((function (){var obj68087 = tr;
if((!((obj68087 == null)))){
return (obj68087["state"]);
} else {
return undefined;
}
})());
