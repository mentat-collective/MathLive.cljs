...
var G__68879 = lambdaisland.glogi.logger.cljs$core$IFn$_invoke$arity$1(name);
if((G__68879 == null)){
return null;
} else {
return lambdaisland.glogi.goog_setLevel(G__68879,lambdaisland.glogi.level(lvl));
}
});
/**
...
var seq__68881 = cljs.core.seq(lvls);
var chunk__68883 = null;
var count__68884 = (0);
var i__68885 = (0);
while(true){
if((i__68885 < count__68884)){
var vec__68895 = chunk__68883.cljs$core$IIndexed$_nth$arity$2(null,i__68885);
var logger = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68895,(0),null);
var level = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68895,(1),null);
var level_68939__$1 = ((typeof level === 'string')?cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(level):level);
lambdaisland.glogi.set_level(logger,level_68939__$1);


var G__68940 = seq__68881;
var G__68941 = chunk__68883;
var G__68942 = count__68884;
var G__68943 = (i__68885 + (1));
seq__68881 = G__68940;
chunk__68883 = G__68941;
count__68884 = G__68942;
i__68885 = G__68943;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__68881);
if(temp__5753__auto__){
var seq__68881__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__68881__$1)){
var c__4679__auto__ = cljs.core.chunk_first(seq__68881__$1);
var G__68946 = cljs.core.chunk_rest(seq__68881__$1);
var G__68948 = c__4679__auto__;
var G__68949 = cljs.core.count(c__4679__auto__);
var G__68950 = (0);
seq__68881 = G__68946;
chunk__68883 = G__68948;
count__68884 = G__68949;
i__68885 = G__68950;
continue;
} else {
var vec__68899 = cljs.core.first(seq__68881__$1);
var logger = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68899,(0),null);
var level = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68899,(1),null);
var level_68951__$1 = ((typeof level === 'string')?cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(level):level);
lambdaisland.glogi.set_level(logger,level_68951__$1);


var G__68952 = cljs.core.next(seq__68881__$1);
var G__68953 = null;
var G__68954 = (0);
var G__68955 = (0);
seq__68881 = G__68952;
chunk__68883 = G__68953;
count__68884 = G__68954;
i__68885 = G__68955;
continue;
}
} else {
...
var temp__5753__auto___68957 = goog.debug.Console.instance;
if(cljs.core.truth_(temp__5753__auto___68957)){
var instance_68958 = temp__5753__auto___68957;
instance_68958.setCapturing(true);

var instance_68959__$1 = (new goog.debug.Console());
(goog.debug.Console.instance = instance_68959__$1);

instance_68959__$1.setCapturing();
} else {
}
...
var G__68902 = (new goog.debug.FancyWindow());
G__68902.setEnabled(true);
...
var G__68903 = (new goog.debug.DivConsole(element));
G__68903.setCapturing(true);
...
var len__4864__auto___68961 = arguments.length;
var i__4865__auto___68962 = (0);
while(true){
if((i__4865__auto___68962 < len__4864__auto___68961)){
args__4870__auto__.push((arguments[i__4865__auto___68962]));

var G__68963 = (i__4865__auto___68962 + (1));
i__4865__auto___68962 = G__68963;
continue;
} else {
}
break;
...
/** @this {Function} */
(lambdaisland.glogi.swap_handlers_BANG_.cljs$lang$applyTo = (function (seq68909){
var G__68910 = cljs.core.first(seq68909);
var seq68909__$1 = cljs.core.next(seq68909);
var G__68911 = cljs.core.first(seq68909__$1);
var seq68909__$2 = cljs.core.next(seq68909__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__68910,G__68911,seq68909__$2);
}));
...
var G__68920 = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"sequenceNumber","sequenceNumber",-543983615),record.sequenceNumber_,new cljs.core.Keyword(null,"time","time",1385887882),record.time_,new cljs.core.Keyword(null,"level","level",1290497552),cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(clojure.string.lower_case(record.level_.name)),new cljs.core.Keyword(null,"message","message",-406056002),record.msg_,new cljs.core.Keyword(null,"logger-name","logger-name",-1988126927),record.loggerName_,new cljs.core.Keyword(null,"exception","exception",-335277064),record.exception_], null);
return (handler_fn.cljs$core$IFn$_invoke$arity$1 ? handler_fn.cljs$core$IFn$_invoke$arity$1(G__68920) : handler_fn.call(null,G__68920));
});
if(cljs.core.truth_(logger)){
var temp__5753__auto___68979 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(lambdaisland.glogi.logger_glogi_handlers(logger),handler_fn);
if(cljs.core.truth_(temp__5753__auto___68979)){
var handler_68980 = temp__5753__auto___68979;
lambdaisland.glogi.goog_removeHandler(logger,handler_68980);
} else {
}
...
return lambdaisland.glogi.goog_addHandler(G__68921,log_record_handler);
}
} else {
return null;
}
...
var logger = lambdaisland.glogi.logger.cljs$core$IFn$_invoke$arity$1(name);
if(cljs.core.truth_(logger)){
var temp__5753__auto___68982 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(lambdaisland.glogi.logger_glogi_handlers(logger),handler_fn);
if(cljs.core.truth_(temp__5753__auto___68982)){
var handler_68984 = temp__5753__auto___68982;
lambdaisland.glogi.goog_removeHandler(logger,handler_68984);
} else {
}
