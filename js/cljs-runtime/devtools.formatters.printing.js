...
var len__4864__auto___54641 = arguments.length;
var i__4865__auto___54642 = (0);
while(true){
if((i__4865__auto___54642 < len__4864__auto___54641)){
args__4870__auto__.push((arguments[i__4865__auto___54642]));

var G__54644 = (i__4865__auto___54642 + (1));
i__4865__auto___54642 = G__54644;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq54569){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__54570,G__54571,seq54569__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__54586_SHARP_){
return (!((cljs.core.meta(p1__54586_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54590__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e54591){var _e__53803__auto__ = e54591;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e54593){var _e__53803__auto__ = e54593;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__54620 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__54621 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__54621);

try{var map__54622 = opts;
var map__54622__$1 = cljs.core.__destructure_map(map__54622);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54622__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__54620);
}});
...
var temp__5751__auto___54661 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___54661)){
var managed_print_level_54662 = temp__5751__auto___54661;
var _STAR_print_level_STAR__orig_val__54633_54663 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__54634_54664 = managed_print_level_54662;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__54634_54664);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__54627_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__54627_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__54633_54663);
}} else {
job_fn();
}
