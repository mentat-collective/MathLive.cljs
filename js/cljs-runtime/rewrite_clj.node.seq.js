...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k66513,else__4505__auto__){
var self__ = this;
var this__4504__auto____$1 = this;
var G__66527 = k66513;
var G__66527__$1 = (((G__66527 instanceof cljs.core.Keyword))?G__66527.fqn:null);
switch (G__66527__$1) {
case "tag":
return self__.tag;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k66513,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__66546){
var vec__66548 = p__66546;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66548,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66548,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__66512){
var self__ = this;
var G__66512__$1 = this;
return (new cljs.core.RecordIter((0),G__66512__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"format-string","format-string",832187437),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this66514,other66515){
var self__ = this;
var this66514__$1 = this;
return (((!((other66515 == null)))) && ((((this66514__$1.constructor === other66515.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this66514__$1.tag,other66515.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this66514__$1.format_string,other66515.format_string)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this66514__$1.wrap_length,other66515.wrap_length)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this66514__$1.seq_fn,other66515.seq_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this66514__$1.children,other66515.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this66514__$1.__extmap,other66515.__extmap)))))))))))))));
}));
...
var self__ = this;
var _node__$1 = this;
var G__66570 = rewrite_clj.node.protocols.sexprs.cljs$core$IFn$_invoke$arity$2(self__.children,opts);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__66570) : self__.seq_fn.call(null,G__66570));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k66513){
var self__ = this;
var this__4509__auto____$1 = this;
var G__66588 = k66513;
var G__66588__$1 = (((G__66588 instanceof cljs.core.Keyword))?G__66588.fqn:null);
switch (G__66588__$1) {
case "tag":
case "format-string":
case "wrap-length":
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k66513);

}
}));

(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__66512){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__66589 = cljs.core.keyword_identical_QMARK_;
var expr__66590 = k__4511__auto__;
if(cljs.core.truth_((pred__66589.cljs$core$IFn$_invoke$arity$2 ? pred__66589.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__66590) : pred__66589.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__66590)))){
return (new rewrite_clj.node.seq.SeqNode(G__66512,self__.format_string,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__66589.cljs$core$IFn$_invoke$arity$2 ? pred__66589.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"format-string","format-string",832187437),expr__66590) : pred__66589.call(null,new cljs.core.Keyword(null,"format-string","format-string",832187437),expr__66590)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__66512,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__66589.cljs$core$IFn$_invoke$arity$2 ? pred__66589.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__66590) : pred__66589.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__66590)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,G__66512,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__66589.cljs$core$IFn$_invoke$arity$2 ? pred__66589.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__66590) : pred__66589.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__66590)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,G__66512,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__66589.cljs$core$IFn$_invoke$arity$2 ? pred__66589.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__66590) : pred__66589.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__66590)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,self__.seq_fn,G__66512,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__66512),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__66512){
var self__ = this;
var this__4501__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,self__.seq_fn,self__.children,G__66512,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__66524){
var extmap__4542__auto__ = (function (){var G__66607 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__66524,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"format-string","format-string",832187437),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__66524)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__66607);
} else {
return G__66607;
}
})();
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__66524),new cljs.core.Keyword(null,"format-string","format-string",832187437).cljs$core$IFn$_invoke$arity$1(G__66524),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__66524),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__66524),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__66524),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),"(%s)",(2),(function (p1__66610_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__66610_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),"{%s}",(2),(function (p1__66615_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__66615_SHARP_);
}),children);
});
