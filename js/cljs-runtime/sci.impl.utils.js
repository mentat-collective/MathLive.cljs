...
var map__70242 = cljs.core.meta(iobj);
var map__70242__$1 = cljs.core.__destructure_map(map__70242);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70242__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70242__$1,new cljs.core.Keyword(null,"column","column",2078222095));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__70242__$1,new cljs.core.Keyword(null,"file","file",-1269645878),cljs.core.deref(sci.impl.utils.current_file));
...
var map__70259 = (function (){var or__4253__auto__ = stack;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
var G__70261 = env;
var G__70261__$1 = (((G__70261 == null))?null:cljs.core.deref(G__70261));
var G__70261__$2 = (((G__70261__$1 == null))?null:new cljs.core.Keyword("sci.impl","callstack","sci.impl/callstack",-1621010557).cljs$core$IFn$_invoke$arity$1(G__70261__$1));
var G__70261__$3 = (((G__70261__$2 == null))?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__70261__$2,id));
var G__70261__$4 = (((G__70261__$3 == null))?null:cljs.core.deref(G__70261__$3));
var G__70261__$5 = (((G__70261__$4 == null))?null:cljs.core.last(G__70261__$4));
if((G__70261__$5 == null)){
return null;
} else {
return cljs.core.meta(G__70261__$5);
}
}
})();
var map__70259__$1 = cljs.core.__destructure_map(map__70259);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70259__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70259__$1,new cljs.core.Keyword(null,"column","column",2078222095));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70259__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
var new_exception = (function (){var new_d = (function (){var G__70264 = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword("sci","error","sci/error",-979082803),new cljs.core.Keyword(null,"line","line",212345235),line,new cljs.core.Keyword(null,"column","column",2078222095),column,new cljs.core.Keyword(null,"message","message",-406056002),ex_msg__$1,new cljs.core.Keyword("sci.impl","callstack","sci.impl/callstack",-1621010557),st,new cljs.core.Keyword(null,"file","file",-1269645878),file], null);
if(cljs.core.truth_(phase)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__70264,new cljs.core.Keyword(null,"phase","phase",575722892),phase);
} else {
return G__70264;
}
})();
...
/** @this {Function} */
(sci.impl.utils.vary_meta_STAR_.cljs$lang$applyTo = (function (seq70269){
var G__70270 = cljs.core.first(seq70269);
var seq70269__$1 = cljs.core.next(seq70269);
var G__70271 = cljs.core.first(seq70269__$1);
var seq70269__$2 = cljs.core.next(seq70269__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__70270,G__70271,seq70269__$2);
}));

sci.impl.utils.strip_core_ns = (function sci$impl$utils$strip_core_ns(sym){
var G__70276 = cljs.core.namespace(sym);
switch (G__70276) {
case "clojure.core":
case "cljs.core":
...
var fexpr__70286 = cljs.core.deref(sci.impl.utils.eval_form_state);
return (fexpr__70286.cljs$core$IFn$_invoke$arity$2 ? fexpr__70286.cljs$core$IFn$_invoke$arity$2(sci_ctx,form) : fexpr__70286.call(null,sci_ctx,form));
});
/**
...
var run = cljs.core.cons(fst,cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__70288_SHARP_){
return f(p1__70288_SHARP_);
}),cljs.core.next(s)));
return cljs.core.cons(run,(function (){var G__70290 = pred;
var G__70291 = (new cljs.core.LazySeq(null,(function (){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2(cljs.core.count(run),s);
}),null,null));
return (sci.impl.utils.split_when.cljs$core$IFn$_invoke$arity$2 ? sci.impl.utils.split_when.cljs$core$IFn$_invoke$arity$2(G__70290,G__70291) : sci.impl.utils.split_when.call(null,G__70290,G__70291));
})());
} else {
return null;
}
...
var G__70378 = cljs.core.next(params__$1);
var G__70379 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new_params,cljs.core.first(params__$1));
var G__70380 = lets;
params__$1 = G__70378;
new_params = G__70379;
lets = G__70380;
...
var G__70381 = cljs.core.next(params__$1);
var G__70382 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new_params,gparam);
var G__70383 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(lets,cljs.core.first(params__$1)),gparam);
params__$1 = G__70381;
new_params = G__70382;
lets = G__70383;
continue;
...
var G__70320 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(expr_meta,new cljs.core.Keyword(null,"ns","ns",441598760),cljs.core.deref(sci.impl.utils.current_ns),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"file","file",-1269645878),cljs.core.deref(sci.impl.utils.current_file)], 0));
if(cljs.core.truth_(special_QMARK_)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__70320,new cljs.core.Keyword(null,"special","special",-1125941630),true);
} else {
return G__70320;
}
}));
...
var args__4870__auto__ = [];
var len__4864__auto___70385 = arguments.length;
var i__4865__auto___70386 = (0);
while(true){
if((i__4865__auto___70386 < len__4864__auto___70385)){
args__4870__auto__.push((arguments[i__4865__auto___70386]));

var G__70387 = (i__4865__auto___70386 + (1));
i__4865__auto___70386 = G__70387;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.utils.log.cljs$lang$applyTo = (function (seq70321){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq70321));
}));

sci.impl.utils.dynamic_var = (function sci$impl$utils$dynamic_var(var_args){
var G__70330 = arguments.length;
switch (G__70330) {
case 1:
...
var G__70345 = sci.impl.utils.new_var.cljs$core$IFn$_invoke$arity$4(name,null,null,false);
sci.impl.vars.unbind(G__70345);
