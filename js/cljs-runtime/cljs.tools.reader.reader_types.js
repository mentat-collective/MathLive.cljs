...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_57078 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_57078(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_57079 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_57079(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_57084 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_57084(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_57088 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_57088(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_57093 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_57093(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_57094 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_57094(reader);
}
});
...
var G__57109 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__57110 = s.append(c);
c = G__57109;
s = G__57110;
continue;
}
