...
var len__4864__auto___76550 = arguments.length;
var i__4865__auto___76551 = (0);
while(true){
if((i__4865__auto___76551 < len__4864__auto___76550)){
args__4870__auto__.push((arguments[i__4865__auto___76551]));

var G__76552 = (i__4865__auto___76551 + (1));
i__4865__auto___76551 = G__76552;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.opts.process_permissions.cljs$lang$applyTo = (function (seq76499){
var G__76500 = cljs.core.first(seq76499);
var seq76499__$1 = cljs.core.next(seq76499);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__76500,seq76499__$1);
}));
...
var G__76553 = null;
var G__76553__1 = (function (msg){
return (new Error(msg));
});
var G__76553__2 = (function (msg,filename){
return (new Error(msg,filename));
});
var G__76553__3 = (function (msg,filename,line){
return (new Error(msg,filename,line));
});
G__76553 = function(msg,filename,line){
switch(arguments.length){
case 1:
return G__76553__1.call(this,msg);
case 2:
return G__76553__2.call(this,msg,filename);
case 3:
return G__76553__3.call(this,msg,filename,line);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__76553.cljs$core$IFn$_invoke$arity$1 = G__76553__1;
G__76553.cljs$core$IFn$_invoke$arity$2 = G__76553__2;
G__76553.cljs$core$IFn$_invoke$arity$3 = G__76553__3;
return G__76553;
})()
], null),new cljs.core.Symbol(null,"cljs.core.Delay","cljs.core.Delay",-1917476777,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.Delay,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),(function (p1__76509_SHARP_){
return (new cljs.core.Delay(p1__76509_SHARP_,null));
})], null),new cljs.core.Symbol(null,"goog.string.StringBuffer","goog.string.StringBuffer",-1220229842,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),goog.string.StringBuffer,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),(function (p1__76510_SHARP_){
return (new goog.string.StringBuffer(p1__76510_SHARP_));
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__76515 = temp__5751__auto__;
var sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76515,(0),null);
var class_opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76515,(1),null);
var G__76557 = cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$arity$3(class__GT_opts,sym,((cljs.core.map_QMARK_(class_opts))?class_opts:new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),class_opts], null)));
var G__76558 = cljs.core.rest(kvs);
class__GT_opts = G__76557;
kvs = G__76558;
continue;
} else {
 ...
 * Initializes options
 */
sci.impl.opts.init = (function sci$impl$opts$init(p__76522){
var map__76523 = p__76522;
var map__76523__$1 = cljs.core.__destructure_map(map__76523);
var features = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76523__$1,new cljs.core.Keyword(null,"features","features",-1146962336));
var namespaces = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76523__$1,new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469));
var ns_aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76523__$1,new cljs.core.Keyword(null,"ns-aliases","ns-aliases",1290254821));
var bindings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76523__$1,new cljs.core.Keyword(null,"bindings","bindings",1271397192));
var readers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76523__$1,new cljs.core.Keyword(null,"readers","readers",-2118263030));
var reify_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76523__$1,new cljs.core.Keyword(null,"reify-fn","reify-fn",-1360983316));
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76523__$1,new cljs.core.Keyword(null,"env","env",-1815813235));
var imports = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76523__$1,new cljs.core.Keyword(null,"imports","imports",-1249933394));
var allow = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76523__$1,new cljs.core.Keyword(null,"allow","allow",-1857325745));
var load_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76523__$1,new cljs.core.Keyword(null,"load-fn","load-fn",-2121144334));
var async_load_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76523__$1,new cljs.core.Keyword(null,"async-load-fn","async-load-fn",-472170029));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76523__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
var deny = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76523__$1,new cljs.core.Keyword(null,"deny","deny",1589338523));
var proxy_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76523__$1,new cljs.core.Keyword(null,"proxy-fn","proxy-fn",1116677438));
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76523__$1,new cljs.core.Keyword(null,"classes","classes",2037804510));
...
var map__76529 = opts;
var map__76529__$1 = cljs.core.__destructure_map(map__76529);
var features = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76529__$1,new cljs.core.Keyword(null,"features","features",-1146962336));
var namespaces = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76529__$1,new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469));
var ns_aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76529__$1,new cljs.core.Keyword(null,"ns-aliases","ns-aliases",1290254821));
var bindings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76529__$1,new cljs.core.Keyword(null,"bindings","bindings",1271397192));
var readers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76529__$1,new cljs.core.Keyword(null,"readers","readers",-2118263030));
var reify_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76529__$1,new cljs.core.Keyword(null,"reify-fn","reify-fn",-1360983316));
var imports = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76529__$1,new cljs.core.Keyword(null,"imports","imports",-1249933394));
var allow = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76529__$1,new cljs.core.Keyword(null,"allow","allow",-1857325745));
var load_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__76529__$1,new cljs.core.Keyword(null,"load-fn","load-fn",-2121144334),new cljs.core.Keyword(null,"load-fn","load-fn",-2121144334).cljs$core$IFn$_invoke$arity$1(env));
var async_load_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__76529__$1,new cljs.core.Keyword(null,"async-load-fn","async-load-fn",-472170029),new cljs.core.Keyword(null,"async-load-fn","async-load-fn",-472170029).cljs$core$IFn$_invoke$arity$1(env));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76529__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
var deny = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76529__$1,new cljs.core.Keyword(null,"deny","deny",1589338523));
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76529__$1,new cljs.core.Keyword(null,"classes","classes",2037804510));
