...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k66280,else__4505__auto__){
var self__ = this;
var this__4504__auto____$1 = this;
var G__66294 = k66280;
var G__66294__$1 = (((G__66294 instanceof cljs.core.Keyword))?G__66294.fqn:null);
switch (G__66294__$1) {
case "value":
return self__.value;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k66280,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__66298){
var vec__66300 = p__66298;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66300,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66300,(1),null);
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__66279){
var self__ = this;
var G__66279__$1 = this;
return (new cljs.core.RecordIter((0),G__66279__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"base","base",185279322)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this66281,other66282){
var self__ = this;
var this66281__$1 = this;
return (((!((other66282 == null)))) && ((((this66281__$1.constructor === other66282.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this66281__$1.value,other66282.value)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this66281__$1.base,other66282.base)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this66281__$1.__extmap,other66282.__extmap)))))))));
}));
...
var abs_value = (function (){var G__66322 = self__.value;
if((self__.value < (0))){
return (- G__66322);
} else {
return G__66322;
...
var prefix = (function (){var G__66326 = cljs.core.long$(self__.base);
switch (G__66326) {
case (8):
return "0";
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k66280){
var self__ = this;
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__66279){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__66338 = cljs.core.keyword_identical_QMARK_;
var expr__66339 = k__4511__auto__;
if(cljs.core.truth_((pred__66338.cljs$core$IFn$_invoke$arity$2 ? pred__66338.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"value","value",305978217),expr__66339) : pred__66338.call(null,new cljs.core.Keyword(null,"value","value",305978217),expr__66339)))){
return (new rewrite_clj.node.integer.IntNode(G__66279,self__.base,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__66338.cljs$core$IFn$_invoke$arity$2 ? pred__66338.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"base","base",185279322),expr__66339) : pred__66338.call(null,new cljs.core.Keyword(null,"base","base",185279322),expr__66339)))){
return (new rewrite_clj.node.integer.IntNode(self__.value,G__66279,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.integer.IntNode(self__.value,self__.base,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__66279),null));
}
}
}));
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__66279){
var self__ = this;
var this__4501__auto____$1 = this;
return (new rewrite_clj.node.integer.IntNode(self__.value,self__.base,G__66279,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.integer.map__GT_IntNode = (function rewrite_clj$node$integer$map__GT_IntNode(G__66283){
var extmap__4542__auto__ = (function (){var G__66342 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__66283,new cljs.core.Keyword(null,"value","value",305978217),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"base","base",185279322)], 0));
if(cljs.core.record_QMARK_(G__66283)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__66342);
} else {
return G__66342;
}
})();
return (new rewrite_clj.node.integer.IntNode(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__66283),new cljs.core.Keyword(null,"base","base",185279322).cljs$core$IFn$_invoke$arity$1(G__66283),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
