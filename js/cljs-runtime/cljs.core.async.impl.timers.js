...
var i_58999 = (0);
while(true){
if((i_58999 < arr.length)){
(arr[i_58999] = null);

var G__59000 = (i_58999 + (1));
i_58999 = G__59000;
continue;
} else {
}
...
var i_59011 = (self__.level + (1));
while(true){
if((i_59011 <= (new_level + (1)))){
(update[i_59011] = self__.header);

var G__59012 = (i_59011 + (1));
i_59011 = G__59012;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_59013 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_59013[i]));
} else {
x__$2.forward.push((((i < links_59013.length))?(links_59013[i]):null));
}

if((i < links_59013.length)){
(links_59013[i] = x__$2);
} else {
links_59013.push(x__$2);
}
...
var i_59015 = (0);
while(true){
if((i_59015 <= self__.level)){
var links_59016 = (update[i_59015]).forward;
if((x__$1 === (((i_59015 < links_59016.length))?(links_59016[i_59015]):null))){
(links_59016[i_59015] = (x__$1.forward[i_59015]));

var G__59017 = (i_59015 + (1));
i_59015 = G__59017;
continue;
} else {
var G__59018 = (i_59015 + (1));
i_59015 = G__59018;
continue;
}
} else {
...
var G__59020 = nx;
var G__59021 = (level__$1 - (1));
x = G__59020;
level__$1 = G__59021;
continue;
} else {
var G__59022 = x;
var G__59023 = (level__$1 - (1));
x = G__59022;
level__$1 = G__59023;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__59025 = nx;
var G__59026 = (level__$1 - (1));
x = G__59025;
level__$1 = G__59026;
continue;
} else {
var G__59027 = x;
var G__59028 = (level__$1 - (1));
x = G__59027;
level__$1 = G__59028;
continue;
}
